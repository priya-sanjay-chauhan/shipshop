...
const Login = () => {
  ...
  <div
    ...
    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
      ...
      <h1 class="text-xl font-bold leading-tight tracking-tight  md:text-2xl ">Login to your
        account
      </h1>
      </div>
      <form class="space-y-4 md:space-y-6" method="POST">
        ...
        <p class="text-sm font-light text-gray-500 dark:text-gray-400">Don't have an account? <Link to={'/signup'}
            class="font-medium text-blue-600 hover:underline dark:text-blue-500" >Signup here</Link>
        </p>
      </form>
    </div>
  </div>

            ...
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    ...
                    <div className=" bg-emerald-50 py-5 rounded-xl border border-emerald-100">
                        ...
                        <div className="flex justify-center">
                            <FcBusinesswoman className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100"/>
                        </div>
                        {/* text  */}
                        <div className="">
                ...
                <div className="bottom">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        ...
                        {/* main 2 */}
                        <div className="mt-5 flex flex-col overflow-hidden rounded-xl border border-emerald-100 md:flex-row">
                            {/* main 3  */}
                            <div className="w-full border-r border-emerald-100 bg-emerald-50 md:max-w-xs">
                                {/* left  */}
                                <div className="p-8">
